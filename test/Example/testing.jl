...
# ╔═╡ 15a50f6e-2a7c-435b-879f-b2ab90cb6171
using Makie, CairoMakie

# ╔═╡ 30067656-58f2-11ec-045b-cb82bb7a1018
using UnROOT

# ╔═╡ fecd9ed5-c7c0-4353-822b-6f48721c2e00
using PlutoUI

# ╔═╡ d0c90c4f-31c8-4e35-ae19-c434fcd2e141
pwd()

# ╔═╡ d1d0e0fc-e797-4ce5-8e03-22e6287414d2
f = ROOTFile("hist2D.root")

# ╔═╡ f0186327-fc1e-4d7c-933d-c4123641cb15
"""
...
# ╔═╡ e4b1b39a-5887-4243-8d5c-9ffe0c5b9554
Emins = [e for e in 0:100:3500 ]

# ╔═╡ dc4648fe-7745-425b-8366-b23c4fb32694
Emaxs = [e for e in 0:100:3500 ]

# ╔═╡ f6ea4f8f-228d-4e56-970f-f6addc934895
hm = zeros(36,36)

# ╔═╡ 78baadd1-8b2e-4847-b3fd-8535927a7d4b
for emin in eachindex(Emins)
	for emax in eachindex(Emaxs)
		hm[emin,emax] = get_bin_content(f, "h2", Emins[emin], Emaxs[emax])
	end
end

# ╔═╡ 128701bc-1511-4f88-a589-e2d44e9968a5
heatmap(Emins, Emaxs, hm)

# ╔═╡ 9778d89f-821c-41c0-a5dc-c7123dc9590c
function get_SB_ratio(S, B, C...)
	println(S)
	println(B)
	println(C)
end
...
julia_version = "1.8.0-DEV.1089"
manifest_format = "2.0"
project_hash = "38874408f66965807ca608dde5ea0b3e6381628e"
...
git-tree-sha1 = "cd9daed5fb719bd5a82d29264ad6cedd91f06cf1"
...
[[deps.Mixers]]
deps = ["MacroTools"]
git-tree-sha1 = "f3dc82a759768fb5c219222634f551667aed1bb8"
...
[[deps.UnROOT]]
deps = ["AbstractTrees", "ArraysOfArrays", "CodecLz4", "CodecXz", "CodecZstd", "IterTools", "LRUCache", "LazyArrays", "LibDeflate", "LorentzVectors", "Memoization", "Mixers", "Parameters", "PrettyTables", "StaticArrays", "Tables", "TypedTables"]
git-tree-sha1 = "337386b701c4f2aad7d47c081d8ac652557decd4"
...
[[deps.libdeflate_jll]]
deps = ["Libdl", "Pkg"]
git-tree-sha1 = "bcd2cff21d43b203ac1e91f536eb314c29406a52"
